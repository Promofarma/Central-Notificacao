<!-- Sidebar -->
<aside class="flex flex-col sm:p-4 gap-y-6 grow max-w-16 sm:max-w-20 md:max-w-56 xl:max-w-64">
    <!-- Navigation -->
    <nav
                ...
                this.$nextTick(() => {
                    ...
                    Array.from(items).forEach(item => {
                        ...
                        if (this.currentUrl.includes(resourceName)) {
                            item.classList.add('bg-white', 'text-slate-900', 'shadow-slate-300/10', 'shadow');
                        }
                    });
                });
            }
    ...
    >
        ...
        <a
            ...
            class="flex items-center text-sm px-3 py-2 md:gap-3 justify-center md:justify-start rounded-lg font-medium text-slate-500 transition-colors duration-150 hover:bg-white hover:shadow-sm hover:shadow-slate-300/10 hover:text-slate-900 focus:outline-none [&>svg]:size-5"
        >
            <x-heroicon-s-home />
